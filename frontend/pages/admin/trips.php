    ...
    <div class="row">
        ...
        <div class="col-md-1">
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a href="http://mymoyo.co.za" class="nav-link">Logout</a>
                </li>
            </ul>
        </div>
        <div class="col-md-11">
                    ...
                    <form role="form" id="tripForm" action="#" method="post">
                        <div class="form-row">
                            <div class="form-group col-sm-6 col-md-4 col-xl-3">
                                ...
                                <select class="form-control" id="busNumber" name="busNumber" required>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-primary col-md-3" id="createTripBtn">Submit</button>
                            </div>
                        </div>
                    </form>
            ...
            <div class="row">
                <div class="col-md-12">
                    <table class="table table-bordered table-striped table-hover table-responsive-xl mt-3">
                        ...
                        <tbody class="text-center" id="tripsTable"></tbody>
                    </table>
                </div>
            </div>
        </div>
...
<!-- Scripts -->
<script src="../../js/trips_crud.js"></script>
